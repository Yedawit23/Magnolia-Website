        ...
        <div class="col-md-5">
          <div class="login-aside text-center  d-flex flex-column flex-row-auto">
            ...
            <div class="text-center  brand-logo">
              ...
              <img class="logo-abbr" src="assets/uploads/nana.png" alt="">
            </div>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><h3> Nana Express Admin Login</h3></a>
  </div>
  <div class="card-1">
...
<div class="form-group mb-3">
  ...
  <div>
    <input type="email" class="form-control" value="" name="email" required placeholder="enter email">
...
<script>
  $(document).ready(function(){
    ...
    success:function(resp){
        location.href = 'index.php?page=home'; // Always redirect to home
      }
    })
  })
  })
